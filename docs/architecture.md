...
- [Жизненный цикл прошивки и OTA](./firmware_lifecycle.md) — режимы работы, стратегия обновлений и защита от сбоев.
- [Спецификация протокола v0.2.3](./protocol_spec_v0.2.md) — бинарные структуры и команды.
